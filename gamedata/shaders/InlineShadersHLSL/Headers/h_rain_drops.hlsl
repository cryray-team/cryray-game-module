...
{
	float2 distorted_uv = l_jh2(uv, float4(0.35f, 1.f, 0.f, 1.f), GM_DROPS_TURBTIME);
	
    float s = StaticDrops(lerp(uv, distorted_uv, GM_DROPS_TURBCOF), t)*l0; 
    float2 m1 = DropLayer2(lerp(uv, distorted_uv, GM_DROPS_TURBCOF), t)*l1;
    float2 m2 = DropLayer2(lerp(uv, distorted_uv * 1.75f, GM_DROPS_TURBCOF), t)*l2;
