...
public:
    ...
    BOOL _empty()
    {
        return items.empty() &&
            (0 ==
                (uintptr_t(children[0]) | uintptr_t(children[1]) | uintptr_t(children[2]) | uintptr_t(children[3]) |
                    uintptr_t(children[4]) | uintptr_t(children[5]) | uintptr_t(children[6]) | uintptr_t(children[7])));
    }
};
