...
void CScriptFcolor::script_register(lua_State* L)
{
    module(L)[class_<Fcolor>("fcolor")
                  ...
                  .def(constructor<>())
                  .def("set", (Fcolor & (Fcolor::*)(float, float, float, float))(&Fcolor::set), return_reference_to(_1xxx))
                  .def("set", (Fcolor & (Fcolor::*)(const Fcolor&))(&Fcolor::set), return_reference_to(_1xxx))
                  .def("set", (Fcolor & (Fcolor::*)(u32))(&Fcolor::set), return_reference_to(_1xxx))];
}
