...
//------------------------------------------------------------------------------
using TOnDrawTextEvent = fastdelegate::FastDelegate<void(PropValue*, xr_string&)>; 
using TOnClick = fastdelegate::FastDelegate<void(PropItem*)>;
...
public:
    using TOnBeforeEditEvent = fastdelegate::FastDelegate<void(PropValue*, T&)>;
	using TOnAfterEditEvent = fastdelegate::FastDelegate<void(PropValue*, T&, bool)>;
...
private:
    ...
    // events
public:
    using TOnPropItemFocused = fastdelegate::FastDelegate<void(PropItem*)>;
...
public:
    using TOnTestEqual = fastdelegate::FastDelegate<void(CanvasValue*,CanvasValue*,bool&)>;
	using TOnDrawCanvasEvent = fastdelegate::FastDelegate<void(CanvasValue*,void* /* TCanvas* */, const Irect&)>;
...
public:
    RStringVec value;
    int btn_num;
    using TOnBtnClick = fastdelegate::FastDelegate<void(ButtonValue*, bool&, bool&)>;
...
{
public:
    using TOnValidateResult = fastdelegate::FastDelegate<void(ShortcutValue*,const xr_shortcut&,bool&)>;
...
public:
    using TOnBeforeEditEvent = fastdelegate::FastDelegate<void(PropValue*, xr_string&)>;
    using TOnAfterEditEvent = fastdelegate::FastDelegate<void(PropValue*, xr_string&, bool)>;
    TOnBeforeEditEvent OnBeforeEditEvent;
    TOnAfterEditEvent OnAfterEditEvent;
...
public:
    ...
    using TOnChooseValueFill = fastdelegate::FastDelegate<void(ChooseValue*)>;
