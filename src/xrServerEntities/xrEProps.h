...
using TOnILItemsFocused = fastdelegate::FastDelegate<void(ListItemsVec&)>;
using TOnILCloseEvent = fastdelegate::FastDelegate<void()>;
using TOnItemRename =  fastdelegate::FastDelegate<void(LPCSTR, LPCSTR, EItemType)>;
using TOnItemRemove =  fastdelegate::FastDelegate<void(LPCSTR, EItemType, bool&)>;
using TOnItemAfterRemove =  fastdelegate::FastDelegate<void()>;
using TOnCloseEvent =  fastdelegate::FastDelegate<void()>;
using TOnModifiedEvent =  fastdelegate::FastDelegate<void()>;
