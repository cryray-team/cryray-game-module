...
public:
    ...
    // false, u32 tessel = 7 ) = 0; virtual	void DBG_DrawRotationY( const Fmatrix &m, float ang0, float ang1, float
    // size, u32 ac, bool solid = false, u32 tessel = 7 ) = 0; virtual	void DBG_DrawRotationZ( const Fmatrix &m, float
    // ang0, float ang1, float size, u32 ac, bool solid = false, u32 tessel = 7 ) = 0;
