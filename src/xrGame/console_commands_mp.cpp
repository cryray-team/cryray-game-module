...
void ENGINE_API DumpNetCompressorStats(bool brief);
extern BOOL ENGINE_API g_net_compressor_enabled;
extern BOOL ENGINE_API g_net_compressor_gather_stats;
