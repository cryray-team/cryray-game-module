...
{
    module(
        L)[class_<ScriptLight>("script_light")
               .def(constructor<>())
               ...
               .property(
                   "volumetric_distance", &ScriptLight::GetVolumetricDistance, &ScriptLight::SetVolumetricDistance)
               .property(
                   "volumetric_intensity", &ScriptLight::GetVolumetricIntensity, &ScriptLight::SetVolumetricIntensity)
