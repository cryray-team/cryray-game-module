...
class GAME_API CActor : public CEntityAlive,
...
public:
    ...
    void OnActorFootstep(shared_str material);
...
protected:
    ...
    ref_sound m_actor_snd[3];
    shared_str sCurrentStepMaterial;
...
private:
    ...
    virtual void PlayMovementAnm(shared_str name, bool wpn_aim, bool hud);

    virtual void PlayCamera(shared_str name, bool hud);

public:
    void SwitchNightVision(bool light_on, bool use_sounds = true);

    void CreateNightVision();
    void SetNightVisionStatus(bool val, bool use_sounds);
...
extern GAME_API CActor* g_actor;
