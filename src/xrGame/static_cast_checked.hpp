...
struct value
{
    ...
    IC static void check(source_type* source)
    {
...
struct helper
{
    ...
    template <>
    IC static void check<false>(source_type source)
    {
    }
};
...
IC destination_type static_cast_checked(source_type const& source)
{
...
template <typename destination_type, typename source_type>
IC destination_type static_cast_checked(source_type& source)
{
    typedef object_type_traits::remove_pointer<source_type>::type pointerless_type;
    typedef object_type_traits::remove_reference<pointerless_type>::type pure_source_type;
