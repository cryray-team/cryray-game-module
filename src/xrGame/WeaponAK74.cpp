...
void CWeaponAK74::script_register(lua_State* L)
{
    module(L)[class_<CWeaponAK74, CGameObject>("CWeaponAK74").def(constructor<>()),
        ...
        class_<CWeapon, CGameObject>("CWeapon")
            ...
            .enum_("EWeaponStates")[value("eFire", int(EWeaponStates::eFire)),
                value("eFire2", int(EWeaponStates::eFire2)), value("eReload", int(EWeaponStates::eReload)),
                value("eMisfire", int(EWeaponStates::eMisfire)), value("eMagEmpty", int(EWeaponStates::eMagEmpty)),
                value("eSwitch", int(EWeaponStates::eSwitch)), value("eSwitchMode", int(EWeaponStates::eSwitchMode))]
            .enum_("EWeaponSubStates")[value("eSubstateReloadBegin", int(EWeaponSubStates::eSubstateReloadBegin)),
