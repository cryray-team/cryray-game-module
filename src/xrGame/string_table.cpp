...
void CStringTable::Init()
{
    ...
    snprintf(discord_strings.mainmenu, 128, xr_ToUTF8(*CStringTable().translate("st_main_menu"), 128));
    snprintf(discord_strings.paused, 128, xr_ToUTF8(*CStringTable().translate("st_pause_menu"), 128));
    snprintf(discord_strings.loading, 128, xr_ToUTF8(*CStringTable().translate("st_loading"), 128));
    snprintf(discord_strings.health, 128, xr_ToUTF8(*CStringTable().translate("st_ui_health_sensor"), 128));
    snprintf(discord_strings.dead, 128, xr_ToUTF8(*CStringTable().translate("st_player_dead"), 128));
    snprintf(discord_strings.livesleft, 128, xr_ToUTF8(*CStringTable().translate("st_hardcore_lives_left"), 128));
    snprintf(discord_strings.livesleftsingle, 128,
        xr_ToUTF8(*CStringTable().translate("st_hardcore_lives_left_single"), 128));
    snprintf(
        discord_strings.livespossessed, 128, xr_ToUTF8(*CStringTable().translate("st_azazel_lives_possessed"), 128));
    snprintf(discord_strings.livespossessedsingle, 128,
        xr_ToUTF8(*CStringTable().translate("st_azazel_lives_possessed_single"), 128));
    snprintf(discord_strings.godmode, 128, xr_ToUTF8(*CStringTable().translate("st_godmode"), 128));
