...
void CScriptGameObject::IterateRuck(luabind::functor<bool> functor, luabind::object object)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::IterateRuck non-CInventoryOwner object !!!");
        return;
    }
...
void CScriptGameObject::IterateBelt(luabind::functor<bool> functor, luabind::object object)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::IterateBelt non-CInventoryOwner object !!!");
        return;
    }
...
void CScriptGameObject::SetCanBeHarmed(bool state)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CEntityAlive : cannot access class member set_can_be_harmed!");
        return;
    }
...
bool CScriptGameObject::CanBeHarmed()
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CEntityAlive : cannot access class member can_be_harmed!");
        return false;
    }
...
void CScriptGameObject::MoveItemToRuck(CScriptGameObject* pItem)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::MoveItemToRuck non-CInventoryOwner object !!!");
        return;
    }
...
void CScriptGameObject::MoveItemToSlot(CScriptGameObject* pItem, u16 slot_id)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::MoveItemToSlot non-CInventoryOwner object !!!");
        return;
    }
...
void CScriptGameObject::MoveItemToBelt(CScriptGameObject* pItem)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::MoveItemToBelt non-CInventoryOwner object !!!");
        return;
    }
...
void CScriptGameObject::ItemAllowTrade(CScriptGameObject* pItem)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CScriptGameObject::ItemAllowTrade non-CInventoryOwner object !!!");
        return;
    }
    item->AllowTrade();
}
...
void CScriptGameObject::night_vision_allowed(bool value)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "CActor : cannot access class member enable_night_vision!");
        return;
    }
...
void CScriptGameObject::SetTorchBatteryStatus(u16 value)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "This method works only for torch, check your code!");
        return;
    }
}
...
void CScriptGameObject::SetTorchState(bool state)
{
    ...
    {
        ai().script_engine().script_log(
            ScriptStorage::eLuaMessageTypeError, "This method works only for actor, check your code!");
        return;
    }
}
