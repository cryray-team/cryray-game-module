...
void CArtefact::Load(LPCSTR section)
{
    ...
    m_fSleepRestoreSpeed = READ_IF_EXISTS(pSettings, r_float, section, "sleep_restore_speed", 0.f);
    ...
    if (pSettings->section_exist(pSettings->r_string(section, "hit_absorbation_sect")))
    {
        ...
        m_ArtefactHitImmunities[ALife::eHitTypeTelepatic] =
            READ_IF_EXISTS(pSettings, r_float, hit_sect, "telepathic_immunity", 0.f);
        m_ArtefactHitImmunities[ALife::eHitTypeChemicalBurn] =
            READ_IF_EXISTS(pSettings, r_float, hit_sect, "chemical_burn_immunity", 0.f);
        m_ArtefactHitImmunities[ALife::eHitTypeExplosion] =
            READ_IF_EXISTS(pSettings, r_float, hit_sect, "explosion_immunity", 0.f);
        m_ArtefactHitImmunities[ALife::eHitTypeFireWound] =
            READ_IF_EXISTS(pSettings, r_float, hit_sect, "fire_wound_immunity", 0.f);
...
void CArtefact::StartLights()
{
    ...
    m_pTrailLight = xrAPI.Render->light_create();
