...
//	Description : Visual memory manager IC functions
////////////////////////////////////////////////////////////////////////////
...
IC const CVisualMemoryManager::VISIBLES& CVisualMemoryManager::objects() const
{
    m_objects->erase(std::remove_if(m_objects->begin(), m_objects->end(),
                         [](const auto& obj) { return obj.m_object->getDestroy(); }),
        m_objects->end());
    return *m_objects;
}
...
IC float CVisualMemoryManager::visibility_threshold() const { return (current_state2().m_visibility_threshold); }

IC float CVisualMemoryManager::transparency_threshold() const { return (current_state2().m_transparency_threshold); }
