						   ...
						   float x1, float y1, float x2, float y2)
{
	...
	if (R && R->size())
	{
		...
		{
			xrAPI.UIRender->PushPoint((*R)[0+0].pt.x, (*R)[0+0].pt.y,	0, color, (*R)[0+0].uv.x, (*R)[0+0].uv.y);
			xrAPI.UIRender->PushPoint((*R)[k+1].pt.x, (*R)[k+1].pt.y,	0, color, (*R)[k+1].uv.x, (*R)[k+1].uv.y);
			xrAPI.UIRender->PushPoint((*R)[k+2].pt.x, (*R)[k+2].pt.y,	0, color, (*R)[k+2].uv.x, (*R)[k+2].uv.y);
		}
	}
}
//--------------------------------------------------------------------
