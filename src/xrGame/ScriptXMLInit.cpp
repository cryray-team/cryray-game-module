...
UISpinNum::CUISpinNum* CScriptXmlInit::InitSpinNum(LPCSTR path, CUIWindow* parent)
{
    UISpinNum::CUISpinNum* pWnd = xr_new<UISpinNum::CUISpinNum>();
...
UISpinText::CUISpinText* CScriptXmlInit::InitSpinText(LPCSTR path, CUIWindow* parent)
{
    UISpinText::CUISpinText* pWnd = xr_new<UISpinText::CUISpinText>();
    CUIXmlInit::InitSpin(m_xml, path, 0, pWnd);
    _attach_child(pWnd, parent);
    return pWnd;
}
