...
CEntityCondition::SConditionChangeV& CEntityCondition::change_v() { return m_change_v; }
...
void CEntityCondition::ChangeArtefactReaction(const float value) { m_fDeltaArtefactReaction += value; }
...
void CEntityCondition::UpdatePsyHealth() { m_fDeltaPsyHealth += change_v().m_fV_PsyHealth * m_fDeltaTime; }
...
void SMedicineInfluenceValues::Load(const shared_str& sect)
{
    ...
    fArtefactReaction = READ_IF_EXISTS(pSettings, r_float, sect.c_str(), "eat_artefact_reaction", 0.0f);
