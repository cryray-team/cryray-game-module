...
class_<CScriptGameObject>& script_register_game_object1(class_<CScriptGameObject>& instance)
{
    instance
        ...
        .def("bind_object", &CScriptGameObject::bind_object, adopt(_2xxx))
        ...
        .def("set_override_animation", (void(CScriptGameObject::*)(const char*))(&CScriptGameObject::set_override_animation))
        .def("set_override_animation",
            (void(CScriptGameObject::*)(u32, u32))(&CScriptGameObject::set_override_animation))
