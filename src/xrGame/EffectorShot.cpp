...
void CWeaponShotEffector::Shot(CWeapon* weapon)
{
    ...
    float angle = m_cam_recoil.Dispersion * weapon->cur_silencer_koef.cam_dispersion *
        weapon->cur_scope_koef.cam_dispersion * weapon->cur_launcher_koef.cam_dispersion * k_cam_disp;
    angle += m_cam_recoil.DispersionInc * weapon->cur_silencer_koef.cam_disper_inc *
        weapon->cur_scope_koef.cam_disper_inc * weapon->cur_launcher_koef.cam_disper_inc * (float)m_shot_numer;
    Shot2(angle);
}
