...
UIProgressShape::CUIProgressShape* g_MissileForceShape = NULL;
...
void create_force_progress()
{
    ...
    CUIXmlInit xml_init;
    g_MissileForceShape = xr_new<UIProgressShape::CUIProgressShape>();
...
void CMissile::setup_throw_params()
{
    ...
    if (this == inventory_owner->inventory().ActiveItem())
    {
        ...
        if (NULL == io->inventory().ActiveItem())
        {
            ...
            Msg("state_time: %u", m_dwStateTime);
...
void CMissile::GetBriefInfo_ammo(
