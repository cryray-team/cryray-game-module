...
using sending_state_callback_t = fastdelegate::FastDelegate<void(sending_status_t, u32, u32)>;
using receiving_state_callback_t = fastdelegate::FastDelegate<void(receiving_status_t, u32, u32)>;
