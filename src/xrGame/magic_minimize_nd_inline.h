...
IC int& _MinimizeND::MaxLevel() { return m_kMinimizer.MaxLevel(); }

TEMPLATE_SPECIALIZATION
IC int& _MinimizeND::MaxBracket() { return m_kMinimizer.MaxBracket(); }

TEMPLATE_SPECIALIZATION
IC void*& _MinimizeND::UserData() { return m_pvUserData; }
