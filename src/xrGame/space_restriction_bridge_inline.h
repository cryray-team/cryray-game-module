...
//	Description : Space restriction bridge IC functions
////////////////////////////////////////////////////////////////////////////
    ...
    T restriction, const Fvector& position, Fvector& result, bool out_restriction)
{
    ...
    ASSERT_FMT(!restriction->accessible_neighbour_border(restriction, out_restriction).empty(),
        "[%s]: %s has accessible_neighbour_border().empty()", __FUNCTION__, name().c_str());
