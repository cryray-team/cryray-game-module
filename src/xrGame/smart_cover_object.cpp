...
void smart_cover::object::Center(Fvector& result) const { XFORM().transform_tiny(result, CFORM()->getSphere().P); }

float smart_cover::object::Radius() const { return (CFORM()->getRadius()); }

void smart_cover::object::UpdateCL() { NODEFAULT; }

void smart_cover::object::shedule_Update(u32 dt) { NODEFAULT; }
