...
void SaveDemoInfo();
IC demo_info* GetDemoInfo() const { return m_demo_info; }
...
IC BOOL IsDemoPlayStarted() { return (IsDemoPlay() && m_DemoPlayStarted); }
IC BOOL IsDemoPlayFinished() { return m_DemoPlayStoped; }
IC BOOL IsDemoSaveStarted() { return (IsDemoSave() && m_DemoSaveStarted); }
...
IC bool IsDemoInfoSaved() { return m_demo_info != nullptr; }
bool LoadDemoHeader();
