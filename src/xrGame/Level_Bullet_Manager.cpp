...
void CBulletManager::Render()
{
    ...
    xrAPI.UIRender->StartPrimitive((u32)bullet_num * 12, IUIRender::ptTriList, IUIRender::pttLIT);
    ...
    xrAPI.UIRender->CacheSetCullMode(IUIRender::cmNONE);
    xrAPI.UIRender->CacheSetXformWorld(Fidentity);
    xrAPI.UIRender->SetShader(*tracers.sh_Tracer);
    xrAPI.UIRender->FlushPrimitive();
    xrAPI.UIRender->CacheSetCullMode(IUIRender::cmCCW);
}
