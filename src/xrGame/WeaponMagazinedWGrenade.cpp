...
void CWeaponMagazinedWGrenade::PlayAnimShow()
{
    ...
    {
        if (!m_bGrenadeMode)
            m_ammoElapsed.type1 == 0 && HudAnimationExist("anm_show_empty_w_gl") ?
                PlayHUDMotion("anm_show_empty_w_gl", FALSE, this, GetState()) :
                PlayHUDMotion("anm_show_w_gl", FALSE, this, GetState());
        else
            m_ammoElapsed.type1 == 0 && HudAnimationExist("anm_show_empty_g") ?
...
void CWeaponMagazinedWGrenade::PlayAnimHide()
{
    ...
    if (IsGrenadeLauncherAttached())
        if (!m_bGrenadeMode)
            m_ammoElapsed.type1 == 0 && HudAnimationExist("anm_hide_empty_w_gl") ?
                PlayHUDMotion("anm_hide_empty_w_gl", TRUE, this, GetState()) :
                PlayHUDMotion("anm_hide_w_gl", TRUE, this, GetState());
        else
            m_ammoElapsed.type1 == 0 && HudAnimationExist("anm_hide_empty_g") ?
...
void CWeaponMagazinedWGrenade::PlayAnimIdle()
{
    ...
    if (IsGrenadeLauncherAttached())
    {
        ...
        {
            if (m_bGrenadeMode)
                m_ammoElapsed.type1 == 0 && HudAnimationExist("anm_idle_empty_g_aim") ?
                    PlayHUDMotion("anm_idle_empty_g_aim", TRUE, NULL, GetState()) :
                    PlayHUDMotion("anm_idle_g_aim", TRUE, NULL, GetState());
            else
                m_ammoElapsed.type1 == 0 && HudAnimationExist("anm_idle_empty_w_gl_aim") ?
...
void CWeaponMagazinedWGrenade::PlayAnimShoot()
{
    if (m_bGrenadeMode)
    {
        if (m_ammoElapsed.type1 > 1 || !HudAnimationExist("anm_shot_g_l"))
        {
    ...
    else
    {
        ...
        if (IsGrenadeLauncherAttached())
            if (m_ammoElapsed.type1 > 1 || !HudAnimationExist("anm_shot_w_gl_l"))
            {
...
{
    if (m_bGrenadeMode)
        m_ammoElapsed.type1 == 0 && HudAnimationExist("anm_switch_g_empty") ?
        ...
        m_ammoElapsed.type1 == 0 && HudAnimationExist("anm_switch_empty") ?
...
bool CWeaponMagazinedWGrenade::TryPlayAnimBore()
{
    if (IsGrenadeLauncherAttached())
    {
        if (m_bGrenadeMode)
        {
            if (m_ammoElapsed.type1 == 0 && HudAnimationExist("anm_bore_empty_g"))
            {
        ...
        {
            if (m_ammoElapsed.type1 == 0 && HudAnimationExist("anm_bore_empty_w_gl"))
            {
...
bool CWeaponMagazinedWGrenade::install_upgrade_ammo_class(LPCSTR section, bool test)
{
    ...
    bool result = process_if_exists(
        section, "ammo_mag_size", &CInifile::r_s32, m_bGrenadeMode ? iMagazineSize : iMagazineSize2, test);
