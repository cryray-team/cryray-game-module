...
//	Description : ALife spawn registry IC functions
////////////////////////////////////////////////////////////////////////////
    ...
    CSE_ALifeAnomalousZone* anomaly, CSE_ALifeDynamicObject* object) const
{
    ...
    u32 arraySize = m_artefact_spawn_positions.size();

    object->o_Position = m_artefact_spawn_positions[index % arraySize].level_point();
    object->m_tNodeID = m_artefact_spawn_positions[index % arraySize].level_vertex_id();
    object->m_fDistance = m_artefact_spawn_positions[index % arraySize].distance();
