...
CObjectActionStrapping::~CObjectActionStrapping()
{
    if (m_callback_removed)
    {
        VERIFY(!object().animation().torso().callback(
            fastdelegate::MakeDelegate(this, &CObjectActionStrapping::on_animation_end)));
        return;
    }
...
CObjectActionStrappingToIdle::~CObjectActionStrappingToIdle()
{
    ...
    {
        VERIFY(!object().animation().torso().callback(
            fastdelegate::MakeDelegate(this, &CObjectActionStrappingToIdle::on_animation_end)));
        return;
    }
...
CObjectActionUnstrapping::~CObjectActionUnstrapping()
{
    ...
    {
        VERIFY(!object().animation().torso().callback(
            fastdelegate::MakeDelegate(this, &CObjectActionUnstrapping::on_animation_end)));
        return;
    }
...
CObjectActionUnstrappingToIdle::~CObjectActionUnstrappingToIdle()
{
    ...
    {
        VERIFY(!object().animation().torso().callback(
            fastdelegate::MakeDelegate(this, &CObjectActionUnstrappingToIdle::on_animation_end)));
        return;
    }
