...
void CCar::DbgCreatePlots()
{
    ...
    //////////////////////////////
    int y_pos = 0, y_w = 100;
    m_dbg_power_rpm.Init(fastdelegate::MakeDelegate(this, &CCar::Parabola), m_min_rpm, m_max_rpm, 0, y_pos, 500, y_w,
    ...
    m_dbg_torque_rpm.Init(
        fastdelegate::MakeDelegate(this, &CCar::TorqueRpmFun), m_min_rpm, m_max_rpm, 0, y_pos, 500, y_w, 1000);
