...
public:
    IC sight_manager_enable_guard(CSightManager& manager, bool const value) : m_manager(manager), m_value(value) {}

    IC void enable(bool const value) { m_value = value; }

    IC bool enable() const { return (m_value); }

    IC ~sight_manager_enable_guard()
    {
