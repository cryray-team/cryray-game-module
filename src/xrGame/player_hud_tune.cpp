...
float _delta_pos = READ_IF_EXISTS(pCryRaySettings, r_float, "hud_adj", "_delta_pos", 0.0005f);
float _delta_rot = READ_IF_EXISTS(pCryRaySettings, r_float, "hud_adj", "_delta_rot", 0.05f);
