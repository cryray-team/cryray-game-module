...
class UISpinNum::CUISpinNum;
class UISpinText::CUISpinText;
...
public:
    ...
    UISpinNum::CUISpinNum* InitSpinNum(LPCSTR path, CUIWindow* parent);
    UISpinText::CUISpinText* InitSpinText(LPCSTR path, CUIWindow* parent);
