...
void draw_rect(Frect& r, u32 color)
{
    ...
    xrAPI.UIRender->StartPrimitive(5, IUIRender::ptLineStrip, UI().m_currentPointType);

    xrAPI.UIRender->PushPoint(r.lt.x, r.lt.y, 0, color, 0, 0);
    xrAPI.UIRender->PushPoint(r.rb.x, r.lt.y, 0, color, 0, 0);
    xrAPI.UIRender->PushPoint(r.rb.x, r.rb.y, 0, color, 0, 0);
    xrAPI.UIRender->PushPoint(r.lt.x, r.rb.y, 0, color, 0, 0);
    xrAPI.UIRender->PushPoint(r.lt.x, r.lt.y, 0, color, 0, 0);
