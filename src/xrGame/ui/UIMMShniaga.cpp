...
void CUIMMShniaga::InitShniaga(CUIXml& xml_doc, LPCSTR path)
{
    ...
    if (music_type_menu == 0)
        m_sound->Init(xml_doc, "menu_sound");
    else if (music_type_menu == 1)
        m_sound->Init(xml_doc, "menu_sound_narodnaya_solyanka");
    else if (music_type_menu == 2)
        m_sound->Init(xml_doc, "menu_sound_sergey_urivin");
    else if (music_type_menu == 3)
        m_sound->Init(xml_doc, "menu_sound_dead_city");
