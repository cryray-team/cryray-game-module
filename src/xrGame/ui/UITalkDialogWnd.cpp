...
void CUITalkDialogWnd::InitTalkDialogWnd()
{
    ...
    UICharacterInfoLeft.InitCharacterInfo(Fvector2().set(0, 0), UIOurIcon.GetWndSize(), "talk\\talk_character.xml");

    UIOthersIcon.AttachChild(&UICharacterInfoRight);
    UICharacterInfoRight.InitCharacterInfo(Fvector2().set(0, 0), UIOthersIcon.GetWndSize(), "talk\\talk_character.xml");
    ...
    AddCallbackStr(
        "question_item", LIST_ITEM_CLICKED, fastdelegate::MakeDelegate(this, &CUITalkDialogWnd::OnQuestionClicked));
