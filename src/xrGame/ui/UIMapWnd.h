...
DEFINE_MAP(shared_str, UICustomMap::CUICustomMap*, GameMaps, GameMapsPairIt);
...
private:
    ...
    float m_currentZoom;
    UIGlobalMap::CUIGlobalMap* m_GlobalMap;
    GameMaps m_GameMaps;
...
public:
    UICustomMap::CUICustomMap* m_tgtMap;
...
public:
    ...
    void SetTargetMap(UICustomMap::CUICustomMap* m, bool bZoomIn = false);
    void SetTargetMap(UICustomMap::CUICustomMap* m, const Fvector2& pos, bool bZoomIn = false);
    ...
    void AddMapToRender(UICustomMap::CUICustomMap*);
    void RemoveMapToRender(UICustomMap::CUICustomMap*);
    UIGlobalMap::CUIGlobalMap* GlobalMap() { return m_GlobalMap; };
    const GameMaps& GameMaps() { return m_GameMaps; };
    UICustomMap::CUICustomMap* GetMapByIdx(u16 idx);
