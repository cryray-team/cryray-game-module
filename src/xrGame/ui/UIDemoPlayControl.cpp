...
void CUIDemoPlayControl::Init()
{
    ...
    AddCallback(m_restart_btn, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUIDemoPlayControl::OnRestart));
    Register(m_decrease_speed_btn);
    AddCallback(m_decrease_speed_btn, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUIDemoPlayControl::OnDecresaseSpeed));
    Register(m_play_pause_btn);
    AddCallback(m_play_pause_btn, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUIDemoPlayControl::OnPlayPause));
    Register(m_increase_speed_btn);
    AddCallback(m_increase_speed_btn, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUIDemoPlayControl::OnIncreaseSpeed));
    Register(m_rewind_until_btn);
    AddCallback(
        m_rewind_until_btn, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUIDemoPlayControl::OnRewindUntil));
    Register(m_repeat_rewind_btn);

    AddCallback(m_rewind_type, PROPERTY_CLICKED, fastdelegate::MakeDelegate(this, &CUIDemoPlayControl::OnRewindTypeSelected));
    AddCallback(m_all_players, PROPERTY_CLICKED, fastdelegate::MakeDelegate(this, &CUIDemoPlayControl::OnRewindPlayerSelected));

    AddCallback(
        m_repeat_rewind_btn, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUIDemoPlayControl::OnRepeatRewind));
