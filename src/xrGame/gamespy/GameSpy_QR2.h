...
private:
    ...
    GAMESPY_FN_VAR_DECL(
        void, qr2_register_clientmessage_callback, (void* qrec, qr2_clientmessagecallback_t cmcallback));
    GAMESPY_FN_VAR_DECL(
        void, qr2_register_publicaddress_callback, (void* qrec, qr2_publicaddresscallback_t pacallback));
    GAMESPY_FN_VAR_DECL(
        void, qr2_register_denyresponsetoip_callback, (void* qrec, qr2_denyqr2responsetoipcallback_t dertoipcallback));

    GAMESPY_FN_VAR_DECL(const char*, GetGameVersion, (const char*));

    GAMESPY_FN_VAR_DECL(qr2_error_t, qr2_initA,
        (qr2_t * qrec, const gsi_char* ip, int baseport, int ispublic, int natnegotiate,
