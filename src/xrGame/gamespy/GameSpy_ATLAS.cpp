...
void CGameSpy_ATLAS::Think() { xrGS_scThink(m_interface); }
...
{
    return xrGS_scSetReportIntention(m_interface, theConnectionId, isAuthoritative, theCertificate, thePrivateData,
        theCallback, theTimeoutMs, theUserData);
}

char const* CGameSpy_ATLAS::GetConnectionId() { return xrGS_scGetConnectionId(m_interface); }
...
{
    return xrGS_scSubmitReport(m_interface, theReport, isAuthoritative, theCertificate, thePrivateData, theCallback,
    ...
    gsi_u32 theProfileId, const GSLoginCertificate* theCertificate)
{
    ...
    return xrGS_scReportSetPlayerData(theReport, thePlayerIndex, thePlayerConnectionId, thePlayerTeamIndex, theResult,
