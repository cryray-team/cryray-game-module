...
void CGameSpy_QR2::Think(void* qrec) { xrGS_qr2_think(qrec); }
void CGameSpy_QR2::ShutDown(void* qrec) { xrGS_qr2_shutdown(qrec); }
...
bool CGameSpy_QR2::Init(int PortID, int Public, void* instance)
{
    ...
    qr2_error_t err = xrGS_qr2_initA(NULL, NULL, PortID, Public, 0, callback_serverkey, callback_playerkey,
        callback_teamkey, callback_keylist, callback_count, callback_adderror, instance);
#ifndef MASTER_GOLD
...
void CGameSpy_QR2::BufferAdd(void* outbuf, const char* value) { xrGS_qr2_buffer_addA(outbuf, value); };

void CGameSpy_QR2::BufferAdd_Int(void* outbuf, int value) { xrGS_qr2_buffer_add_int(outbuf, value); };

void CGameSpy_QR2::KeyBufferAdd(void* keybuffer, int keyid) { xrGS_qr2_keybuffer_add(keybuffer, keyid); }

const char* CGameSpy_QR2::GetGameVersion(const char* result) { return xrGS_GetGameVersion(result); };
