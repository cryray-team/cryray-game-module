...
private:
    ...
    GAMESPY_FN_VAR_DECL(gsi_u32, wsLoginProfile,
    ...
    GAMESPY_FN_VAR_DECL(SCResult, scCreateSession,
    ...
    GAMESPY_FN_VAR_DECL(SCResult, scSetReportIntention,
        (const SCInterfacePtr theInterface, const gsi_u8 theConnectionId[SC_CONNECTION_GUID_SIZE],
    ...
    GAMESPY_FN_VAR_DECL(SCResult, scCreateReport,
    ...
    GAMESPY_FN_VAR_DECL(SCResult, scReportSetPlayerData,
        (SCReportPtr theReport, gsi_u32 thePlayerIndex, const gsi_u8 thePlayerConnectionId[SC_CONNECTION_GUID_SIZE],
            gsi_u32 thePlayerTeamIndex, SCGameResult theResult, gsi_u32 theProfileId,
    ...
    GAMESPY_FN_VAR_DECL(SCResult, scSubmitReport,
