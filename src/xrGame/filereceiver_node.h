...
public:
    ...
    IC u32 const get_downloaded_size() { return m_writer->tell(); };
    // IC	shared_str const &	get_file_name		() { return m_file_name; };
    IC u32 const get_last_read_time() { return m_last_read_time; };
    IC void set_last_read_time(u32 const read_time) { m_last_read_time = read_time; };
    IC IWriter* get_writer() { return m_writer; };
    IC u32 get_user_param() { return m_user_param; };
}; // class filereceiver_node
