...
const char* actor::get_name() const { return m_object.cName().c_str(); }
...
{
public:
    IC passed_doors_predicate(stalker_movement_manager_smart_cover const& movement, actor& actor,
    ...
    IC bool operator()(door* const door) const
    {
