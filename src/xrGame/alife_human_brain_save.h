...
ai().alife().relation_type(this,dynamic_cast<CSE_ALifeMonsterAbstract*>(tpALifeSchedulable)) ? eMeetActionTypeInteract :
...
dynamic_cast<CSE_ALifeHumanAbstract*>(ai().alife().objects().object(*I)); R_ASSERT2
