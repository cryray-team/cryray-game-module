...
void CBinocularsVision::Load(const shared_str& section)
{
    ...
    m_colors[0] = READ_IF_EXISTS(pSettings, r_fcolor, section, "vis_enemy_color", Fcolor().set(TargetColors::EnemyColor));
    m_colors[1] = READ_IF_EXISTS(pSettings, r_fcolor, section, "vis_neutral_color", Fcolor().set(TargetColors::NeutralColor));
    m_colors[2] = READ_IF_EXISTS(pSettings, r_fcolor, section, "vis_friend_color", Fcolor().set(TargetColors::FriendColor));
