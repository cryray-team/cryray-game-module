...
void CCustomOutfit::Load(LPCSTR section)
{
    ...
    clamp(m_artefact_count, static_cast<u32>(0), static_cast<u32>(pSGameSettings->bMoreArtefactsSlots ? 16 : 5));
    ...
    block_bloodsucker = READ_IF_EXISTS(pSettings, r_bool, section, "block_bloodsucker", false);

    bGlassPresent = READ_IF_EXISTS(pSettings, r_bool, section, "glass_present", false);
    bIsExo = !!READ_IF_EXISTS(pSettings, r_bool, section, "is_exo", false);
...
bool CCustomOutfit::install_upgrade_impl(LPCSTR section, bool test)
{
    ...
    result |= process_if_exists_set(section, "helmet_avaliable", &CInifile::r_bool, bIsHelmetAvaliable, test);
    result |= process_if_exists_set(section, "backpack_avaliable", &CInifile::r_bool, bIsBackpackAvaliable, test);
    ...
    result |= process_if_exists_set(section, "block_bloodsucker", &CInifile::r_bool_m, block_bloodsucker, test);
