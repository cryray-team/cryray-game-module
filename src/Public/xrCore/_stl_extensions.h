...
struct pred_str { inline bool operator()(const char* x, const char* y) const { return xr_strcmp(x, y) < 0; } };
struct pred_stri { inline bool operator()(const char* x, const char* y) const { return stricmp(x, y) < 0; } };
