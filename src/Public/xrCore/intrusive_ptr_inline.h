...
template <typename object_type, typename base_type>
IC typename intrusive_ptr<object_type, base_type>::self_type& intrusive_ptr<object_type, base_type>::operator=(
    object_type* rhs)
{
    set(rhs);
...
template <typename object_type, typename base_type>
IC typename intrusive_ptr<object_type, base_type>::object_type& intrusive_ptr<object_type, base_type>::operator*() const
{
    VERIFY(m_object);
    return (*m_object);
}
...
template <typename object_type, typename base_type>
IC typename intrusive_ptr<object_type, base_type>::object_type*
intrusive_ptr<object_type, base_type>::operator->() const
{
    VERIFY(m_object);
    return (m_object);
}
...
template <typename object_type, typename base_type>
IC const typename intrusive_ptr<object_type, base_type>::object_type* intrusive_ptr<object_type, base_type>::get() const
{
    return (m_object);
}
