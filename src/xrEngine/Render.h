...
public:
    ...
    virtual LPCSTR getShaderPath_HLSL() = 0;
    virtual LPCSTR getShaderPath_LUA() = 0;
    ...
    virtual void Screenshot(const bool Console, ScreenshotMode mode = SM_NORMAL, LPCSTR name = 0) = 0;
    virtual void Screenshot(const bool Console, ScreenshotMode mode, CMemoryWriter& memory_writer) = 0;
