...
void anti_aim_ability::load_from_ini(CInifile const* ini, const char* const section)
{
    ...
    m_detection_gain_speed =
        READ_IF_EXISTS(ini, r_float, section, AntiAimAbilityDetails::s_anti_aim_detection_gain_speed_string, 1.f);
    m_detection_loose_speed =
        READ_IF_EXISTS(ini, r_float, section, AntiAimAbilityDetails::s_anti_aim_detection_loose_speed_string, 0.1f);
    const char* effectors =
        READ_IF_EXISTS(ini, r_string, section, AntiAimAbilityDetails::s_anti_aim_effectors_string, NULL);
