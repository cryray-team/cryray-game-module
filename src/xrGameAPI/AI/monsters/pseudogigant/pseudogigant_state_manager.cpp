...
CStateManagerGigantJumper::CStateManagerGigantJumper(CPseudoGigantJumper* monster) : inherited(monster)
{
...
CStateManagerGigantJumper::~CStateManagerGigantJumper() {}
...
void CStateManagerGigantJumper::execute()
{
    u32 state_id = u32(-1);
