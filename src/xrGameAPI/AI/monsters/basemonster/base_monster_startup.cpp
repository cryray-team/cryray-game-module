...
void CBaseMonster::Load(LPCSTR section)
{
    ...
    m_feel_enemy_max_distance = READ_IF_EXISTS(pSettings, r_float, section, "feel_enemy_max_distance",
...
void CBaseMonster::PostLoad(LPCSTR section)
{
    ...
    aom.far_radius = READ_IF_EXISTS(
        pSettings, r_float, section, "aom_far_radius", BaseMonsterStartupDetails::base_monster::aom_far_radius);
    aom.attack_radius = READ_IF_EXISTS(
        pSettings, r_float, section, "aom_attack_radius", BaseMonsterStartupDetails::base_monster::aom_attack_radius);
    ...
    aom.prepare_time = READ_IF_EXISTS(
        pSettings, r_float, section, "aom_prepare_time", BaseMonsterStartupDetails::base_monster::aom_prepare_time);
    aom.prepare_radius = READ_IF_EXISTS(
        pSettings, r_float, section, "aom_prepare_radius", BaseMonsterStartupDetails::base_monster::aom_prepare_radius);
    ...
    if (aom.enabled)
    {
        ...
        const char* attack_on_move_anim_l =
        ...
        const char* attack_on_move_anim_r =
