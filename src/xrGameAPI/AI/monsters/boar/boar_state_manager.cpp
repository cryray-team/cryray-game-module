...
CStateManagerBoar2::CStateManagerBoar2(CAI_CBoar2* monster) : inherited(monster)
{
    add_state(eStateRest, xr_new<CStateMonsterRest<CAI_CBoar2>>(monster));
    add_state(eStateAttack, xr_new<CStateMonsterAttack<CAI_CBoar2>>(monster));
    add_state(eStateEat, xr_new<CStateMonsterEat<CAI_CBoar2>>(monster));
    add_state(eStateHearDangerousSound, xr_new<CStateMonsterHearDangerousSound<CAI_CBoar2>>(monster));
    add_state(eStatePanic, xr_new<CStateMonsterPanic<CAI_CBoar2>>(monster));
    add_state(eStateHitted, xr_new<CStateMonsterHitted<CAI_CBoar2>>(monster));
}

CStateManagerBoar::~CStateManagerBoar() {}
CStateManagerBoar2::~CStateManagerBoar2() {}
...
void CStateManagerBoar2::execute()
{
    u32 state_id = u32(-1);
    const CEntityAlive* enemy = object->EnemyMan.get_enemy();
