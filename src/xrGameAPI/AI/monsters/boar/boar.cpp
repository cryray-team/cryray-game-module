...
CAI_CBoar2::CAI_CBoar2() { StateMan = xr_new<CStateManagerBoar2>(this); }

CAI_Boar::~CAI_Boar() { xr_delete(StateMan); }
CAI_CBoar2::~CAI_CBoar2() { xr_delete(StateMan); }
...
void CAI_CBoar2::Load(LPCSTR section)
{
    inherited::Load(section);
...
BOOL CAI_Boar::net_Spawn(CSE_Abstract* DC)
{
    ...
    {
        CBoneInstance& BI = dynamic_cast<IKinematics*>(Visual())->LL_GetBoneInstance(
...
void CAI_CBoar2::CheckSpecParams(u32 spec_params)
{
