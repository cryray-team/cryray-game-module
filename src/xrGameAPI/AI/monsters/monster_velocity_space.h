...
enum EMovementParametersChimera2
{
    eChimera2VelocityParameterUpperWalkFwd = eVelocityParameterCustom << 1,
    eChimera2VelocityParameterJumpGround = eVelocityParameterCustom << 2,
    eChimera2VelocityParamsUpperWalkFwd = eVelocityParameterStand | eChimera2VelocityParameterUpperWalkFwd,
};
}; // namespace MonsterMovement
