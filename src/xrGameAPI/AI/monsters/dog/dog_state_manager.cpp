...
CStateManagerDog2::CStateManagerDog2(CAI_Dog2* monster) : inherited(monster)
{
    add_state(eStateRest, xr_new<CStateMonsterRest<CAI_Dog2>>(monster));
    add_state(eStatePanic, xr_new<CStateMonsterPanic<CAI_Dog2>>(monster));
    add_state(eStateAttack, xr_new<CStateMonsterAttack<CAI_Dog2>>(monster));
    add_state(eStateEat, xr_new<CStateMonsterEat<CAI_Dog2>>(monster));
    add_state(eStateHearInterestingSound, xr_new<CStateMonsterHearInterestingSound<CAI_Dog2>>(monster));
    add_state(eStateHearDangerousSound, xr_new<CStateMonsterHearDangerousSound<CAI_Dog2>>(monster));
    add_state(eStateHitted, xr_new<CStateMonsterHitted<CAI_Dog2>>(monster));
    add_state(eStateControlled, xr_new<CStateMonsterControlled<CAI_Dog2>>(monster));
    add_state(eStateHearHelpSound, xr_new<CStateMonsterHearHelpSound<CAI_Dog2>>(monster));
}

CStateManagerDog::~CStateManagerDog() {}
CStateManagerDog2::~CStateManagerDog2() {}
...
void CStateManagerDog2::execute()
{
    u32 state_id = u32(-1);
