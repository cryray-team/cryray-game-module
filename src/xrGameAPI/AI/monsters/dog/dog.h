...
class CAI_Dog2 : public CBaseMonster, public CControlledEntity<CAI_Dog2>
{
    typedef CBaseMonster inherited;
    typedef CControlledEntity<CAI_Dog2> CControlled;
...
public:
    ...
    virtual bool ability_can_drag() { return true; }
    virtual char* get_monster_class_name() { return "dog2"; }

    DECLARE_SCRIPT_REGISTER_FUNCTION
};

add_to_type_list(CAI_Dog2)
#undef script_type_list
#define script_type_list save_type_list(CAI_Dog2)