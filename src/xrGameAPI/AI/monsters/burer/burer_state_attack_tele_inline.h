...
namespace BURER_ATTACK_TELE
{
    ...
    //////////////////////////////////////////////////////////////////////////
    class best_object_predicate1
    {
        Fvector enemy_pos;
        Fvector monster_pos;

    public:
        best_object_predicate1(const Fvector& m_pos, const Fvector& pos)
        {
            monster_pos = m_pos;
            enemy_pos = pos;
        }
    ...
    void CStateBurerAttackTele<Object>::SelectObjects()
    {
        std::sort(tele_objects.begin(), tele_objects.end(),
            best_object_predicate1(object->Position(), object->EnemyMan.get_enemy()->Position()));
...
namespace BURER2_ATTACK_TELE
{
    ...
    CStateBurer2AttackTele<_Object>::CStateBurer2AttackTele(_Object* obj) : inherited(obj)
    {
    }

    template <typename _Object>
    void CStateBurer2AttackTele<_Object>::initialize()
    {
        inherited::initialize();
    ...
    template <typename _Object>
    void CStateBurer2AttackTele<_Object>::execute()
    {
        switch (m_action)
        {
        /************************/
    ...
    template <typename _Object>
    void CStateBurer2AttackTele<_Object>::finalize()
    {
        inherited::finalize();
    ...
    template <typename _Object>
    void CStateBurer2AttackTele<_Object>::critical_finalize()
    {
        inherited::critical_finalize();
    ...
    template <typename _Object>
    bool CStateBurer2AttackTele<_Object>::check_start_conditions()
    {
        return CheckTeleStart();
    }

    template <typename _Object>
    bool CStateBurer2AttackTele<_Object>::check_completion()
    {
    ...
    template <typename _Object>
    void CStateBurer2AttackTele<_Object>::FindFreeObjects(xr_vector<CObject*>& tpObjects, const Fvector& pos)
    {
        Level().ObjectSpace.GetNearest(tpObjects, pos, object->m_tele_find_radius, NULL);
    ...
    template <typename _Object>
    void CStateBurer2AttackTele<_Object>::FindObjects()
    {
        u32 res_size = tele_objects.size();
        tele_objects.clear();
    ...
    template <typename _Object>
    void CStateBurer2AttackTele<_Object>::ExecuteTeleStart()
    {
    ...
    template <typename _Object>
    void CStateBurer2AttackTele<_Object>::ExecuteTeleContinue()
    {
        if (time_started + object->m_tele_time_to_hold > Device.dwTimeGlobal)
            return;
    ...
    template <typename _Object>
    void CStateBurer2AttackTele<_Object>::ExecuteTeleFire()
    {
        object->com_man().ta_pointbreak();
        ...
        object->StopTeleObjectParticle(selected_object);
        object->sound().play(CBurer2::eMonsterSoundTeleAttack);
        object->DeactivateShield();
    }

    template <typename _Object>
    bool CStateBurer2AttackTele<_Object>::IsActiveObjects()
    {
        return (object->CTelekinesis::get_objects_count() > 0);
    }

    template <typename _Object>
    bool CStateBurer2AttackTele<_Object>::CheckTeleStart()
    {
        if (object->com_man().ta_is_active())
            return false;
    ...
    template <typename _Object>
    void CStateBurer2AttackTele<_Object>::SelectObjects()
    {
        std::sort(tele_objects.begin(), tele_objects.end(),
