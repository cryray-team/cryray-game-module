...
class BURER_FAST_GRAVI::CBurerFastGravi;
...
public:
    ...
    BURER_FAST_GRAVI::CBurerFastGravi* m_fast_gravi;
...
class CCharacterPhysicsSupport;
class BURER2_FAST_GRAVI::CBurer2FastGravi;

class CBurer2 : public CBaseMonster, public CTelekinesis, public CScanningAbility<CBurer2>
{
    typedef CBaseMonster inherited;
...
public:
    typedef CScanningAbility<CBurer2> TScanner;
    ...
    BURER2_FAST_GRAVI::CBurer2FastGravi* m_fast_gravi;
...
public:
    ...
    virtual bool ability_distant_feel() { return true; }
    virtual char* get_monster_class_name() { return "burer2"; }
...
add_to_type_list(CBurer2)
#undef script_type_list
#define script_type_list save_type_list(CBurer2)
