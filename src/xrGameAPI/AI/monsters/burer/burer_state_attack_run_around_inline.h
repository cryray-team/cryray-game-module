...
namespace BURER_ATTACK_RUN_AROUND
{
    #define DIST_QUANT 10.f

    template <typename _Object>
    CStateBurerAttackRunAround<_Object>::CStateBurerAttackRunAround(_Object* obj) : inherited(obj) { time_started = 0; }

    template <typename _Object>
    void CStateBurerAttackRunAround<_Object>::initialize()
    {
    ...
    template <typename _Object>
    void CStateBurerAttackRunAround<_Object>::execute()
    {
    ...
    template <typename _Object>
    bool CStateBurerAttackRunAround<_Object>::check_start_conditions()
    {
        return true;
    }

    template <typename _Object>
    bool CStateBurerAttackRunAround<_Object>::check_completion()
    {
...
namespace BURER2_ATTACK_RUN_AROUND
{
	#define DIST_QUANT 10.f
	#define TIME_RUN_AWAY 3500

	template <typename _Object>
	CStateBurer2AttackRunAround<_Object>::CStateBurer2AttackRunAround(_Object* obj) : inherited(obj)
	{
	}

	template <typename _Object>
    void CStateBurer2AttackRunAround<_Object>::initialize()
	{
		inherited::initialize();
	...
	template <typename _Object>
    void CStateBurer2AttackRunAround<_Object>::execute()
	{
		if (!fis_zero(dest_direction.square_magnitude()))
		{
			object->path().set_use_dest_orient(true);
	...
	template <typename _Object>
    bool CStateBurer2AttackRunAround<_Object>::check_start_conditions()
	{
		return true;
	}

	template <typename _Object>
    bool CStateBurer2AttackRunAround<_Object>::check_completion()
	{
