...
class CAI_Bloodsucker3 : public CBaseMonster, public CControlledActor
{
    typedef CBaseMonster inherited;

public:
    CAI_Bloodsucker3();
    virtual ~CAI_Bloodsucker3();
...
private:
    ...
    //--------------------------------------------------------------------
public:
    BLOODSUCKER3_ALIEN::CBloodsucker3Alien m_alien_control;
    u32 m_time_lunge;
...
public:
    ...
    virtual char* get_monster_class_name() { return "bloodsucker3"; }
...
add_to_type_list(CAI_Bloodsucker3)
#undef script_type_list
#define script_type_list save_type_list(CAI_Bloodsucker3)